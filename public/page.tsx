...
export const metadata: Metadata = {
  ...
  description:
    "Shop biodegradable tableware and eco-friendly bags made from sugarcane bagasse, areca palm leaf, and other natural materials. Sustainable, compostable, and plastic-free.",
  keywords:
